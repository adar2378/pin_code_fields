...
class PinTheme {
  ...
  /// Color of the input field border when in error mode. Default is [Colors.redAccent]
  ...
  const PinTheme.defaults({
    ...
    this.errorFillColor = Colors.redAccent,
  ...
  factory PinTheme(
    ...
    return PinTheme.defaults(
      ...
      errorFillColor: errorFillColor ?? defaultValues.errorFillColor,
