...
class PinCodeTextField extends StatefulWidget {
  ...
  /// Enable widget separator
  final Widget? separatorWidget;

  /// widget separator position after.
...
class _PinCodeTextFieldState extends State<PinCodeTextField> with TickerProviderStateMixin {
  ...
  Widget? get _separatorWidget => widget.separatorWidget != null ? widget.separatorWidget : null;

  int? get _separatorPosition => widget.separatorPosition != null ? widget.separatorPosition : null;
...
// selects the right fill color for the field
  ...
  List<Widget> _generateFields() {
    ...
    for (int i = 0; i < widget.length; i++) {
      if (_separatorWidget != null && _separatorPosition != null) {
        if (i == (_separatorPosition!)) {
          result.add(
            Container(
              child: Text('-'),
            ),
        ...
        Container(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: (_pinTheme.activeBoxShadows != null || _pinTheme.inActiveBoxShadows != null) ? _getBoxShadowFromIndex(i) : widget.boxShadows,
